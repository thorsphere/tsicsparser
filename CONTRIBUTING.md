...
* **Report Bugs:** If you encounter a bug or unexpected behavior, please open an [Issue](https://github.com/thorsphere/tsicsparser/issues) with a clear description, steps to reproduce, and expected behavior.
* **Feature Requests & Ideas:** If you have an idea for a new feature or improvement, please open an [Issue](https://github.com/thorsphere/tsicsparser/issues) with a clear description and rationale.
* **Questions & Support:** For general questions, deployment setups, or architectural feedback related to the project, please start a thread in [Discussions](https://github.com/thorsphere/tsicsparser/discussions).
